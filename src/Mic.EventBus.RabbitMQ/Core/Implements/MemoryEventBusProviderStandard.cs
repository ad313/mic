...
namespace Mic.EventBus.RabbitMQ.Core.Implements
{
    /// <summary>
    /// 基于内存的发布订阅实现
    /// </summary>
    public class MemoryEventBusProviderStandard : IMemoryEventBusProvider
    {
        ...
        public MemoryEventBusProviderStandard(ISerializerProvider serializerProvider, IServiceProvider serviceProvider)
        {
